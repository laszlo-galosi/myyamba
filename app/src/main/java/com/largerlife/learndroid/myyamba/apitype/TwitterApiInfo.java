...
public class TwitterAPIInfo implements IAPITypeInfo {
    ...
    private static final String AUTH_SECRET = "OwuKvmoUThpBrkI3BKkZuD13jZND7yuJM1vqtH9 BziQK4w3YHf";
    private static final String CALLBACK_SCHEME = "x-yambaapp-oauth-twitter";

    private static final String REGQUEST_URL = "https://api.twitter.com/oauth/request_token";
